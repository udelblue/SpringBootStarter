...
public class StripeUtils {
	...
	/**
	 * Given the card info provided by the user in the front-end, it returns a
	 * parameters map to obtain a Stripe token.
	 * 
	 * @param payload
	 *            The info provided by the user during registration
