...
public class StripeIntegrationTest {
	 ...
	 * @Test
	 * 
	 * @Ignore public void createStripeCustomer() throws Exception {
	 * 
	 * Map<String, Object> tokenParams = new HashMap<String, Object>(); Map<String,
	 * Object> cardParams = new HashMap<String, Object>();
	 ...
	 * customerParams); assertThat(stripeCustomerId, is(notNullValue()));
	 * 
	 * Customer cu = Customer.retrieve(stripeCustomerId); cu.delete();
	 * 
	 * }
	 */
}
